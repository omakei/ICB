            ...
            <tbody>
                {certificates.map((certificate, index)=>(
                    <tr key={certificate.id}>
                        ...
                        <td className="font-w600">{certificate.name}</td>
                        <td className="d-none d-sm-table-cell">{certificate.description}</td>
                        <td className="text-center">
                        <InertiaLink href={route('educationcertificates.edit',department.id)} className="btn btn-circle btn-alt-primary mr-5 mb-5 js-tooltip-enabled" data-toggle="tooltip" data-placement="top" data-original-title="Edit Certificate" title="Edit Certificate">
