        ...
        <div className="content-header content-header-fullrow">
            <div className="content-header-section align-parent">
                ...
                <div className="content-header-item">
                    ...
                    <a className="align-middle link-effect text-primary-dark font-w600" href="#">{user.name}</a>
                </div>
                {/* <!-- END User Info --> */}
            </div>
        </div>
                ...
                <div className="block-content block-content-full block-content-sm bg-body-light">
                    <div className="row">
                        <div className="col-4">
                            ...
                            <div className="font-size-h4">12</div>
                        </div>
                        <div className="col-4">
                            <div className="font-size-sm font-w600 text-uppercase text-muted">Projects</div>
                            <div className="font-size-h4">30</div>
                        </div>
                        <div className="col-4">
                            <div className="font-size-sm font-w600 text-uppercase text-muted">Consaltants</div>
                            <div className="font-size-h4">20</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="block-content">
                    <ul className="list list-activity">
                        <li>
                            ...
                            <div className="font-w600">New Project Created</div>
                            <div>
                                <a href="#">Admin</a>
                            </div>
                ...
                <div className="sidebar-mini-hidden-b text-center">
                    ...
                    <ul className="list-inline mt-10">
                        <li className="list-inline-item">
                            <a className="link-effect text-dual-primary-dark font-size-sm font-w600 text-uppercase" href="#">{user.name}</a>
                        </li>
                        <li className="list-inline-item">
                            {/* <!-- Layout API, functionality initialized in Template._uiApiLayout() --> */}
